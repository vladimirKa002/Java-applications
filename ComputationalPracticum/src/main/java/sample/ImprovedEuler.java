...
// Improved Euler method for plotting the graph
public class ImprovedEuler extends Method{

    ImprovedEuler(Function function, double x0, double y0, double X) {
    ...
    public XYChart.Series getSeries(int N) throws MalformedExpressionException {
        ...
        for (double i = 0; i < N-1; i++){
            double temp = function.calculate(x0 + i*h, y);
            y = y + h/2 * (temp + function.calculate(x0 + i*h+h, y + h * temp));
